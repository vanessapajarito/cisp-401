...
public class CmdLineView {
    ...
    public void startGame(int numberOfGuesses) {
        System.out.println("Guess the word in " + numberOfGuesses + " wrong tries\n");
    ...
    public void losingText(String theWord) {
        System.out.println("Sorry you you lost! The word was: " + theWord);
    }
